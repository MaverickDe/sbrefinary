...
const translations = {
  ES: {
    nav: ["Infraestructura", "Logística", "Estrategia ESG", "Inversores"],
    hero: [
      { title: "Independencia Energética", desc: "Optimizando el complejo de Puertollano para liderar el suministro energético de la Península Ibérica." },
      { title: "Circularidad Total", desc: "Transformando residuos urbanos y biomasa en combustibles renovables de alta calidad." },
      { title: "Pivote Hidrógeno", desc: "Instalación del mayor electrolizador de España para descarbonizar la industria pesada." }
    ],
    overview: {
  ...
  EN: {
    nav: ["Infrastructure", "Logistics", "ESG Strategy", "Investors"],
    hero: [
      { title: "Energy Independence", desc: "Optimizing the Puertollano complex to lead the energy supply of the Iberian Peninsula." },
      { title: "Total Circularity", desc: "Transforming urban waste and biomass into high-quality renewable fuels." },
      { title: "Hydrogen Pivot", desc: "Installing Spain's largest electrolyzer to decarbonize heavy industry." }
    ],
    overview: {
